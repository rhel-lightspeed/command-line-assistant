...
@pytest.fixture
def mock_authorization(chat_interface):
    """Mock D-Bus authorization for all chat interface tests."""
    test_uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    with patch.object(chat_interface, "_get_caller_unix_user_id", return_value=1000):
        with patch.object(
            chat_interface._session_manager, "get_user_id", return_value=test_uid
        ):
            yield


def test_chat_interface_ask_question(chat_interface, mock_config, mock_authorization):
...
def test_delete_all_chat_for_user(
    chat_interface, mock_repository, mock_authorization, caplog
):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    mock_repository.insert({"name": "test", "description": "test", "user_id": uid})
...
def test_delete_all_chat_for_user_no_chat(chat_interface, mock_authorization):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    with pytest.raises(ChatNotFoundError, match="No chat found to delete."):
        chat_interface.DeleteAllChatForUser(uid)


def test_delete_chat_for_user(
    chat_interface, mock_repository, mock_authorization, caplog
):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    mock_repository.insert({"name": "test", "description": "test", "user_id": uid})
...
def test_delete_chat_for_user_exception(chat_interface, mock_authorization):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    with pytest.raises(
        ChatNotFoundError,
...
def test_get_latest_chat_from_user(chat_interface, mock_repository, mock_authorization):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
...
def test_get_chat_id(chat_interface, mock_repository, mock_authorization, caplog):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    inserted = mock_repository.insert(
        {"name": "test", "description": "test", "user_id": uid}
    )
...
def test_get_chat_id_exception(chat_interface, mock_authorization):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
    with pytest.raises(
        ChatNotFoundError,
...
def test_create_chat(chat_interface, mock_authorization):
    uid = "2345f9e6-dfea-11ef-9ae9-52b437312584"
